...
void Localization::LoadTranslations() {
  ...
  en["menu_file_new_file"] = L"New File";
  en["menu_file_reload"] = L"Reload from Disk";
  en["menu_file_open_folder"] = L"Open Folder in Explorer";
  en["menu_file_folders"] = L"Folders";
  en["menu_file_configure_folders"] = L"Configure Folder Entries...";
  en["menu_edit_find_in_files"] = L"Find in Files...";
  en["menu_edit_grep"] = L"Grep...";
  en["menu_edit_find_file"] = L"Find File...";
  en["menu_edit_toggle_box"] = L"Box Selection Mode";
  en["menu_view_tabswitcher"] = L"Tab Grid View";
  en["menu_config_themes"] = L"Themes";
  en["menu_config_shell_encoding"] = L"Shell Encoding";
  ...
  jp["menu_file_new_file"] = L"新規ファイル";
  jp["menu_file_reload"] = L"ディスクから再読み込み";
  jp["menu_file_open_folder"] = L"エクスプローラーでフォルダーを開く";
  jp["menu_file_folders"] = L"フォルダー";
  jp["menu_file_configure_folders"] = L"フォルダーエントリの構成...";
  jp["menu_edit_find_in_files"] = L"複数ファイルから検索...";
  jp["menu_edit_grep"] = L"Grep...";
  jp["menu_edit_find_file"] = L"ファイルを検索...";
  jp["menu_edit_toggle_box"] = L"箱型選択モード";
  jp["menu_view_tabswitcher"] = L"タブのグリッド表示";
  jp["menu_config_themes"] = L"テーマ";
  jp["menu_config_shell_encoding"] = L"シェル文字コード";
  ...
  es["menu_file_new_file"] = L"Nuevo archivo";
  es["menu_file_reload"] = L"Recargar del disco";
  es["menu_file_open_folder"] = L"Abrir carpeta en el Explorador";
  es["menu_file_folders"] = L"Carpetas";
  es["menu_file_configure_folders"] = L"Configurar entradas de carpeta...";
  es["menu_edit_find_in_files"] = L"Buscar en archivos...";
  es["menu_edit_grep"] = L"Grep...";
  es["menu_edit_find_file"] = L"Buscar archivo...";
  es["menu_edit_toggle_box"] = L"Modo de selección de caja";
  es["menu_view_tabswitcher"] = L"Vista de cuadrícula de pestañas";
  es["menu_config_themes"] = L"Temas";
  es["menu_config_shell_encoding"] = L"Codificación de shell";
  ...
  fr["menu_file_new_file"] = L"Nouveau fichier";
  fr["menu_file_reload"] = L"Recharger depuis le disque";
  fr["menu_file_open_folder"] = L"Ouvrir le dossier dans l'Explorateur";
  fr["menu_file_folders"] = L"Dossiers";
  fr["menu_file_configure_folders"] = L"Configurer les dossiers...";
  fr["menu_edit_find_in_files"] = L"Rechercher dans les fichiers...";
  fr["menu_edit_grep"] = L"Grep...";
  fr["menu_edit_find_file"] = L"Rechercher un fichier...";
  fr["menu_edit_toggle_box"] = L"Mode sélection de boîte";
  fr["menu_view_tabswitcher"] = L"Vue en grille des onglets";
  fr["menu_config_themes"] = L"Thèmes";
  fr["menu_config_shell_encoding"] = L"Encodage du shell";
  ...
  de["menu_file_new_file"] = L"Neue Datei";
  de["menu_file_reload"] = L"Vom Datenträger neu laden";
  de["menu_file_open_folder"] = L"Ordner im Explorer öffnen";
  de["menu_file_folders"] = L"Ordner";
  de["menu_file_configure_folders"] = L"Ordner-Einträge konfigurieren...";
  de["menu_edit_find_in_files"] = L"In Dateien suchen...";
  de["menu_edit_grep"] = L"Grep...";
  de["menu_edit_find_file"] = L"Datei suchen...";
  de["menu_edit_toggle_box"] = L"Spaltenauswahlmodus";
  de["menu_view_tabswitcher"] = L"Registerkarten-Gitteransicht";
  de["menu_config_themes"] = L"Themen";
  de["menu_config_shell_encoding"] = L"Shell-Codierung";
