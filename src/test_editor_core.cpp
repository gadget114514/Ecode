...
void TestBufferFolding() {
  ...
  // logical offset 15 (L in Line 3) -> visual offset 7
  assert(buf.LogicalToVisualOffset(15) == 7);
  // Wait, if line 1 (Line 2) is folded, Line 1 is shown, then Line 3.
  // Line 1 ends at offset 7. Line 3 starts at logical 14?
